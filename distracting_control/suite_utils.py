...
DIFFICULTY_SCALE = dict(pse=0.0, easy=0.1, medium=0.2, hard=0.3, hard_bg=0.0)
DIFFICULTY_NUM_VIDEOS = dict(pse=2, easy=4, medium=8, hard=None, hard_bg=None)
DIFFICULTY_NUM_VIDEOS_VAL = dict(pse=None, easy=4, medium=8, hard=None, hard_bg=None)
