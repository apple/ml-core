...
def load(domain_name,
  ...
  if difficulty not in [None, "easy", "medium", "hard", "pse", "hard_bg"]:
    raise ValueError("Difficulty should be one of: 'easy', 'medium', 'hard', 'pse', 'hard_bg'.")
  ...
  if (difficulty or background_kwargs) and allow_background_distraction:
    ...
    if difficulty:
      ...
      if background_dataset_videos in ['val', 'validation']:
        num_videos = suite_utils.DIFFICULTY_NUM_VIDEOS_VAL[difficulty]
      else:
  ...
  if (difficulty or camera_kwargs) and allow_camera_distraction:
  ...
  if (difficulty or color_kwargs) and allow_color_distraction:
